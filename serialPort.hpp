/*
 * @Author: your name
 * @Date: 2020-12-26 15:44:15
 * @LastEditTime: 2020-12-28 19:20:39
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /UART/uart/serialPort.hpp
 */
...
{   
   private:
	int fd;
	struct  termios Opt;
   int speed_arr[9] = {B115200, B57600 ,B38400, B19200, B9600, B4800, B2400, B1200, B300};
   int name_arr[9] = {115200, 57600, 38400, 19200,  9600, 4800, 2400, 1200,  300};
	public:
	 serialPort();
